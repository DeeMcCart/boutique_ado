...
def checkout_success(request, order_number):
    ...
    pofile = UserProfile.objects.get(user=request.user)
    ...
    if save_info:
        ...
        user_profile_form = UesrProfileForm(profile_data, instance=profile)
        if user_prorfile_form.is_valid():
            user_profile_formm.save()
